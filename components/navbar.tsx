...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      {/* Mobile Navbar */}
      <header className="sticky top-5 z-40 mx-auto flex w-[90%] items-center justify-between rounded-2xl border border-secondary  p-2 shadow-inner md:w-[70%] lg:w-[75%] lg:max-w-screen-xl xl:hidden">
      ...
      <header className="sticky top-5 z-40 mx-auto hidden w-[90%] items-center justify-between rounded-2xl border border-secondary bg-card bg-opacity-15 p-2 shadow-inner md:w-[70%] lg:w-[75%] lg:max-w-screen-xl xl:flex">
        ...
        <div className="flex">
          ...
          <Button
            ...
            aria-label="View on GitHub"
          >
            <Link href="https://github.com/avalynndev" target="_blank">
              <Github className="size-5" />
            </Link>
          </Button>
        </div>
